            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6 no-print">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className="border border-gray-300 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-3 bg-gray-100 px-3 py-2 rounded">Bill To Party</h3>
                ...
                {/* Ship To Party */}
                <div className="border border-gray-300 rounded-lg p-4">
                  <h3 className="font-semibold text-gray-800 mb-3 bg-gray-100 px-3 py-2 rounded">Ship To Party</h3>
                  <div className="space-y-3">
                    <input
                      type="text"
                      placeholder="Name"
                  ...
                  <div className="border-b-2 border-gray-800 pb-4 mb-4">
                    <div className="flex justify-between items-start mb-3">
                      <div className="text-xs">
                        ...
                        <div>|| श्री औंजरा माता जी ||</div>
                      </div>
                      <div className="text-xs text-right">
                        <div>Mob. 9414775893</div>
                        <div>9351115678</div>
                      </div>
                    </div>
